...
(function(){
  ...
  exports.histogram = function(width, height){
    ...
    $svg = d3.select(".graph").append("svg").attr("class", "histogram").attr("width", width).attr("height", height).append("g").attr("transform", "translate(" + margins[3] + "," + (height - margins[2]) + ")");
